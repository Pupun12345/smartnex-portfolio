...
import tatSteelLogo from "@/assets/images/tata-steel.png";
import jindalLogo from "@/assets/images/jindal-steel-logo.png";
import rayEngineeringLogo from "@/assets/images/ray-engineering-logo.png";

const clients = [
  {
    name: "Tata Steel Vendors",
    description:
      "Trusted by suppliers in India's largest steel manufacturing ecosystem",
    logo: tatSteelLogo,
  },
  {
    name: "Jindal Vendors",
    description:
      "Serving the vendor network of leading steel and infrastructure company",
    logo: jindalLogo,
  },
  {
    name: "Ray Engineering",
    description: "Innovative engineering solutions provider",
    logo: rayEngineeringLogo,
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Empowering India's leading enterprises with innovative tech
            solutions
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8 items-stretch">
          {clients.map((client, index) => (
            <div
              ...
              } h-full`} // Ensures card takes full column height
            >
