      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="inline-block animate-fade-in-up">
          <div className="relative inline-block py-2">
            <div className="absolute inset-0 bg-primary/10 backdrop-blur-sm border border-primary/30 rounded-3xl"></div>
            <span className="relative px-5 py-3  text-sm font-semibold text-primary">
        ...
        {/* Main heading */}
        <h1
          className="text-6xl md:text-7xl lg:text-8xl font-bold text-balance leading-tight animate-fade-in-up"
        ...
        {/* Subheading */}
        <p
          className="text-lg md:text-xl text-muted-foreground text-balance leading-relaxed max-w-3xl mx-auto animate-fade-in-up"
          style={{ animationDelay: "0.2s" }}
        >
          Healthcare integration platforms, intelligent software solutions, and
          AI-powered attendance systems. Smartnex Technologies empowers
          enterprises with cutting-edge technology designed for scale.
        </p>
        ...
        {/* Tech stats */}
        <div
          className="grid grid-cols-3 gap-8 pt-12 border-t border-border/20 animate-fade-in-up"
